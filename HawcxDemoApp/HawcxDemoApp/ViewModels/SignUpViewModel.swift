...
//            setupBindings()
//        } else {
//            print("Warning: SignUpViewModel initialized without AppViewModel.")
//        }
//    }
//    
//    func resetState() {
...
//            print("[SignUpViewModel] Invalid email format: \(email)")
//            appViewModel.alertInfo = AlertInfo(title: "Invalid Email", message: "Please enter a valid email address.")
//            return
//        }
//        print("[SignUpViewModel] Starting signup process for: \(email)")
//        
...
//            print("[SignUpViewModel] Invalid OTP format: \(otp)")
//            appViewModel.alertInfo = AlertInfo(title: "Invalid OTP", message: "Please enter a valid 6-digit OTP.")
//            return
//        }
//        print("[SignUpViewModel] Verifying OTP: \(otp) for email: \(email)")
//        
//        // Set button-specific loading state instead of global loading
//        isVerifyingOTP = true
//        appViewModel.hideKeyboard()
...
//    
//    func changeEmail() {
//        print("[SignUpViewModel] User requested to change email")
//        showOtpField = false
...
//        guard let appViewModel = appViewModel else { return }
//        guard isEmailValid else {
//            print("[SignUpViewModel] Cannot resend OTP - invalid email: \(email)")
//            appViewModel.alertInfo = AlertInfo(title: "Invalid Email", message: "Cannot resend OTP for an invalid email.")
//            return
//        }
//        print("[SignUpViewModel] Resending OTP for email: \(email)")
//        
...
//        print("[SignUpViewModel] SDK Error: \(signUpErrorCode) - \(errorMessage)")
//        
...
//        print("[SignUpViewModel] SDK Sign Up successful")
//        
//        Task { @MainActor [weak self] in
...
//            self.isResendingOTP = false
//            
////            // Updated message to indicate automatic login
////            appViewModel.alertInfo = AlertInfo(title: "Success", message: "Account created successfully! Logging you in...")
//            
...
//        print("[SignUpViewModel] SDK OTP generated successfully for email")
//#if DEBUG
//        print("[DEBUG] If available, check SDK logs for possible OTP value")
//#endif
//        
//        Task { @MainActor [weak self] in
//            guard let self = self, let appViewModel = self.appViewModel else { return }
