...
//            setupBindings()
//        } else {
//            print("[AddDeviceViewModel] Warning: Initialized without AppViewModel.")
//        }
//    }
//
...
//
//    /// Starts the Add Device flow (equivalent to SignUp's initial action)
////    func startAddDeviceProcess() {
////        // Cannot proceed if already starting/verifying
////        guard !isStartingFlow && !isVerifyingOTP && !isResendingOTP else { return }
////        guard let appViewModel = appViewModel else { return }
////
////        print("[AddDeviceViewModel] Starting Add Device flow via AddDeviceManager for: \(email)")
////        isStartingFlow = true // Set loading state
////        showOtpField = false  // Ensure OTP field is hidden initially
////        canResendOTP = false  // Disable resend initially
...
//        guard let appViewModel = appViewModel else { return }
//
//        print("[AddDeviceViewModel] Resending OTP for: \(email)")
...
//            return
//        }
//        print("[AddDeviceViewModel] Verifying OTP via AddDeviceManager: \(otp) for \(email)")
...
//        print("[AddDeviceViewModel] SDK reported successful device addition.")
...
//            
////            // Added: Show alert indicating automatic login
////            self.appViewModel?.alertInfo = AlertInfo(title: "Device Added",
...
//        print("[AddDeviceViewModel] SDK OTP generated successfully for Add Device.")
//        Task { @MainActor [weak self] in
//            guard let self = self else { return }
...
//        print("[AddDeviceViewModel] SDK Error during Add Device: \(addDeviceErrorCode) - \(errorMessage)")
//        Task { @MainActor [weak self] in
//            guard let self = self else { return }
//            // Reset all loading states
//            self.isStartingFlow = false
